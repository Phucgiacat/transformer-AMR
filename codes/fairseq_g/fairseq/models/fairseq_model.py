...
from fairseq.models import FairseqDecoder, FairseqEncoder, graph_encoder
...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def __init__(self, encoder, decoder, graph_encoder=None):
        ...
        if graph_encoder is not None:
            assert isinstance(self.graph_encoder, FairseqEncoder)

    def forward(self, src_tokens, src_lengths, graph_tokens, graph_lengths, prev_output_tokens, **kwargs):
        """
        ...
        if graph_tokens is not None:
            graph_encoder_output = self.graph_encoder(graph_tokens, graph_lengths, **kwargs)
        decoder_out = self.decoder(
            prev_output_tokens,
            encoder_out=encoder_out,
            graph_encoder_out=graph_encoder_output,
            **kwargs
        )
        return decoder_out
