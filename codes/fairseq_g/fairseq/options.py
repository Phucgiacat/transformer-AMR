...
def add_preprocess_args(parser):
    ...
    group.add_argument("-amr", "--amr", default=None, metavar="AMR", help="AMR")
    ...
    group.add_argument("--thresholdsrc", metavar="N", default=0, type=int,
                       help="map words appearing less than threshold times to unknown")
    group.add_argument("--thresholdamr", metavar='N', default=0, type=int,
                       help="map words appearing less then threshold times to unknown")
